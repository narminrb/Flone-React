...
const HomeBanner = () => {
  return (
    <div className='realative'>
        ...
        <footer className="w-full py-6 bg-transparent absolute top-0 left-0 w-full z-10 bg-transparent border-none">
        ...
        <nav className="bg-transparent border-gray-200 py-6 dark:bg-gray-900 absolute top-[80px] left-0 w-full z-10">
