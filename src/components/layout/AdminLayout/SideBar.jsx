         ...
         <>
         {
            ...
            <div className='col-span-3'>
                    ...
                    <nav className="text-sm text-gray-300">
                        ...
                        <li className="px-4 py-2 text-xs uppercase tracking-wider text-gray-500 font-bold">PRODUCT MANAGEMENT</li>
                        <li className="px-4 cursor-pointer hover:bg-gray-700">
                            <Link className="py-3 flex items-center" to="/">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                                stroke="currentColor" className="w-4 mr-3">
                        ...
                        <li className="px-4 py-2 text-xs uppercase tracking-wider text-gray-500 font-bold">ecommerce</li>
                        <li className="px-4 hover:bg-gray-700">
                            <Link to="#" className="py-3 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                                stroke="currentColor" className="w-4 mr-3">
                                <path strokeLinecap="round" strokeLinejoin="round"
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 18 16.5h-2.25m-7.5 0h7.5m-7.5 0-1 3m8.5-3 1 3m0 0 .5 1.5m-.5-1.5h-9.5m0 0-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6" />
                        ...
                        <li className="px-4 cursor-pointer hover:bg-gray-700">
                            <Link to="#" className="py-2 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 mr-3">
